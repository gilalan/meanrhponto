...
var UserSchema = new Schema({
  ...
  email: {
    ...
    trim: true,
    default: '',
    validate: [validateLocalStrategyEmail, 'Por favor, preencha um e-mail válido']
  },
  username: {
    type: String,
  ...
  provider: {
    type: String,
    required: 'Provedor de autenticação é requerido'
  },
  providerData: {},
  ...
  roles: {
    ...
    default: ['user'],
    required: 'Por favor, preencha um papel/role no sistema'
  },
  updated: {
    type: Date
  },
